...
public class MinecraftVersion {
    ...
    public static class Rules {
        ...
        public static class OS {
            ...
            public net.minecraftforge.mcmaven.util.OS toOS() {
                return switch (name) {
                    case "windows" -> net.minecraftforge.mcmaven.util.OS.WINDOWS;
                    case "linux" -> net.minecraftforge.mcmaven.util.OS.LINUX;
                    case "osx" -> net.minecraftforge.mcmaven.util.OS.MACOS;
                    default -> net.minecraftforge.mcmaven.util.OS.UNKNOWN;
                };
            }
        }
    }
